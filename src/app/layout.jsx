      ...
      <body>
        <div className='shadow-filter'>
          <main className='flex bg-[url(/images/iphone.webp)] bg-no-repeat bg-contain w-[320px] h-[640px] relative'>
            <section className='w-full rounded-[32px] flex gap-3 flex-col overflow-hidden relative px-1.5 py-4 m-6'>
              <div className='absolute bg-white inset-0 -z-10' />
              <Header />
              <div className='relative w-full h-full mx-auto my-0'>
                <article className='overflow-hidden absolute inset-0 w-full h-full z-20'>
                  {children}
                </article>
              </div>
              <Footer />
